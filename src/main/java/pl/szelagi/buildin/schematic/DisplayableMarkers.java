...
public class DisplayableMarkers extends Controller implements IMarkers {
    ...
    private void createHologram(@NotNull Marker marker) {
        ...
        var label = marker.getName() + " §8" + marker.getId();
    ...
    public static DisplayableMarkers empty(@NotNull BaseComponent parent) {
        return new DisplayableMarkers(parent, new Markers());
    }
