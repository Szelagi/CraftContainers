...
public class PlayerChangeConstructor extends PlayerConstructor implements PlayerChange {
    private final @NotNull List<Player> prevPlayers;
    private final @NotNull List<Player> newPlayers;
    public PlayerChangeConstructor(@NotNull Player player, @NotNull List<Player> allPlayers, @NotNull List<Player> prevPlayers, @NotNull List<Player> newPlayers) {
